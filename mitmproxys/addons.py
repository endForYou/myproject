...
sql = "insert into yzy_data_json(url,json_data,params,province,collegeName,data_type) values (%s,%s,%s,%s,%s,%s)"
...
def response(flow):
    ...
    if flow.request.url.startswith(major_score_line_url):
        ...
        try:
            cursor.execute(sql, (major_score_line_url, text, params, province, collegeName,"major_score_line"))
            ...
            cursor1.execute(sql, (major_score_line_url, text, params, province, collegeName,"major_score_line"))
        ...
        # try:
        #     cursor.execute(sql, (enroll_plan_url, text, params, province, collegeName, "enroll_plan"))
        # except BaseException:
        #     db1 = pymysql.connect(user="root", password="rYa+wq10dFTWzYz8FeZgsWRygyKfLKULSRdKfRnEgSk=",
        #                           host="119.91.135.29", port=3306, database="zhiyuan_sd",
        #                           charset="utf8", autocommit=True)
        #     cursor1 = db1.cursor(pymysql.cursors.DictCursor)
        #     cursor1.execute(sql, (enroll_plan_url, text, params, province, collegeName, "enroll_plan"))
